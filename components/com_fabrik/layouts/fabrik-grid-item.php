...
$chx = '<input type="' . $d->type . '" class="form-check-input fabrikinput ' . $inputClass . '" ' . $d->inputDataAttributes .
...
$label = '<label for="'.$thisId.'" class="form-check-label fabrikgrid_'.FabrikString::clean($d->value).'">'.$labelSpan.'</label>';
