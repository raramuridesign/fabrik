...
<select name="<?php echo $d->name . '[year]'; ?>" class="col-md-4 fabrik_filter" <?php echo $data; ?> >
...
<select name="<?php echo $d->name . '[month]'; ?>" class="col-md-4 fabrik_filter" <?php echo $data; ?> >
...
<select name="<?php echo $d->name . '[day]'; ?>" class="col-md-4 fabrik_filter" <?php echo $data; ?> >
