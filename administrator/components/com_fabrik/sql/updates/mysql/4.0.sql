...
ALTER TABLE `#__fabrik_forms` MODIFY `created` datetime NULL DEFAULT NULL;
...
ALTER TABLE `#__fabrik_groups` MODIFY `created` datetime NULL DEFAULT NULL;
...
ALTER TABLE `#__fabrik_lists` MODIFY `created` datetime NULL DEFAULT NULL;
...
ALTER TABLE `#__fabrik_visualizations` MODIFY `created` datetime NULL DEFAULT NULL;
