...
ALTER TABLE `#__fabrik_connections` ALTER `params` SET DEFAULT '';
...
ALTER TABLE `#__fabrik_cron` MODIFY `modified` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
...
ALTER TABLE `#__fabrik_cron` ALTER `params` SET DEFAULT '';
...
ALTER TABLE `#__fabrik_elements` ALTER `label` SET DEFAULT '';
...
ALTER TABLE `#__fabrik_elements` ALTER `params` SET DEFAULT '';
ALTER TABLE `#__fabrik_elements` MODIFY `modified` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
...
ALTER TABLE `#__fabrik_forms` ALTER `intro` SET DEFAULT '';
ALTER TABLE `#__fabrik_forms` MODIFY `created` datetime DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `#__fabrik_forms` ALTER `params` SET DEFAULT '';
ALTER TABLE `#__fabrik_forms` MODIFY `modified` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
...
ALTER TABLE `#__fabrik_form_sessions` ALTER `data` SET DEFAULT '';

ALTER TABLE `#__fabrik_groups` ALTER `name` SET DEFAULT '';
ALTER TABLE `#__fabrik_groups` ALTER `css` SET DEFAULT '';
ALTER TABLE `#__fabrik_groups` ALTER `label` SET DEFAULT '';
ALTER TABLE `#__fabrik_groups` ALTER `published` SET DEFAULT 0;
ALTER TABLE `#__fabrik_groups` MODIFY `created` datetime DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `#__fabrik_groups` ALTER `params` SET DEFAULT '';
ALTER TABLE `#__fabrik_groups` MODIFY `modified` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
...
ALTER TABLE `#__fabrik_jsactions` ALTER `code` SET DEFAULT '';
ALTER TABLE `#__fabrik_jsactions` ALTER `params` SET DEFAULT '';

ALTER TABLE `#__fabrik_lists` ALTER `label` SET DEFAULT '';
ALTER TABLE `#__fabrik_lists` ALTER `introduction` SET DEFAULT '';
...
ALTER TABLE `#__fabrik_lists` MODIFY `created` datetime DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `#__fabrik_lists` ALTER `params` SET DEFAULT '';
ALTER TABLE `#__fabrik_lists` ALTER `form_id` SET DEFAULT 0;
ALTER TABLE `#__fabrik_lists` MODIFY `modified` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
...
ALTER TABLE `#__fabrik_log` ALTER `message` SET DEFAULT '';
...
ALTER TABLE `#__fabrik_validations` ALTER `params` SET DEFAULT '';

ALTER TABLE `#__fabrik_visualizations` ALTER `plugin` SET DEFAULT '';
ALTER TABLE `#__fabrik_visualizations` ALTER `label` SET DEFAULT '';
ALTER TABLE `#__fabrik_visualizations` ALTER `intro_text` SET DEFAULT '';
ALTER TABLE `#__fabrik_visualizations` MODIFY `created` datetime DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `#__fabrik_visualizations` MODIFY `modified` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
