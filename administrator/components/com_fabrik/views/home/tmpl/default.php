...
<table class="adminForm" style="width: 100%">
	<tbody>
		<tr>
			...
			echo $pane->startPanel( Text::_('COM_FABRIK_HOME_ABOUT'), "publish-page");
			echo "<table class='adminlist'>
			<tr><td>".Text::_('COM_FABRIK_HOME_ABOUT_TEXT')."</td></tr></table>";
			echo $pane->endPanel();

			echo $pane->startPanel( Text::_('COM_FABRIK_HOME_NEWS'), "publish-page");
			echo $this->feed;
			echo $pane->endPanel();

			echo $pane->startPanel( Text::_('COM_FABRIK_HOME_STATS'), "publish-page");
			?>
			...
			echo $pane->startPanel( Text::_('COM_FABRIK_HOME_USEFUL_LINKS'), "publish-page");
			?>
			...
			echo $pane->startPanel( Text::_('COM_FABRIK_HOME_TOOLS'), "publish-page"); ?>

			<ul class="adminlist">
				<li><a href="index.php?option=com_fabrik&task=home.installSampleData">
				<?php echo Text::_('COM_FABRIK_HOME_INSTALL_SAMPLE_DATA')?></a>
				</li>
				<li><a onclick="return confirm('<?php echo Text::_('COM_FABRIK_HOME_CONFIRM_WIPE', true);?>')" href="index.php?option=com_fabrik&task=home.reset">
